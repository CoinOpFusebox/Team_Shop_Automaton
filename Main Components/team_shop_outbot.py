...
def compose_combo(needs_heat_transfers, has_player_numbers, needs_player_numbers, has_embroidery, folder_path,
    ...
    #
    # Due to heavy redundancy, but the other "compose" functions will less thoroughly commented upon.
    ...
    #
    # It does not, at present, attach any film art because that would require greater consistency in folder naming,
    # which is not something I can control at the moment.
    #
    # Besides, nobody uses those attachments anyway, they just open the folder directly.
    ...
    # This names the first email after the folder and appends the words "HEAT TRANSFER" for differentiation.
